...
### [Project 1 — Memory Allocation and Performance](Project-1/README.md)
...
### [Project 2 — Threading and Multicore Applications](Project-2/README.md)
...
### [Project 3 — WebGL and Shader Graphics](Project-3/README.md)
...
### [Project 4 — CUDA Applications](Project-4/README.md)

Project 4 compares CPU and GPU implementations of two workloads. The first recreates `std::iota` with a CUDA kernel, and the second generates Julia and Mandelbrot fractals by assigning image pixels to GPU threads.
